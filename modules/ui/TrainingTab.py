...
class TrainingTab:
    ...
    def __create_noise_frame(self, master, row, supports_generalized_offset_noise: bool = False, supports_dynamic_timestep_shifting: bool = False):
        ...
        components.entry(frame, 6, 1, self.ui_state, "min_noising_strength", required=True)
        ...
        components.entry(frame, 7, 1, self.ui_state, "max_noising_strength", required=True)
        ...
        components.entry(frame, 8, 1, self.ui_state, "noising_weight", required=True)
        ...
        components.entry(frame, 9, 1, self.ui_state, "noising_bias", required=True)

        # timestep shift
        components.label(frame, 10, 0, "Timestep Shift",
                         tooltip="Shift the timestep distribution. Use the preview to see more details.")
        components.entry(frame, 10, 1, self.ui_state, "timestep_shift", required=True)
