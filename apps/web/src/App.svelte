...
<main class="page-shell">
  ...
  <Card>
    ...
    {:else if activeTab === 'lora' && loraForm}
      <form class="general-form" on:submit={onSubmitLora}>
        <div class="field-grid">
          <div class="field-row">
        ...
        <div class="action-row">
          ...
          <Button type="button" disabled={saving} on:click={loadLoraConfig}>Reload</Button>
        </div>
      </form>
    {:else if activeTab === 'data' && dataForm}
    ...
    {:else if activeTab === 'backup' && backupForm}
      <form class="general-form" on:submit={onSubmitBackup}>
        <div class="field-grid">
          <div class="field-row split-row">
            <div>
        ...
        <div class="action-row">
          ...
          <Button type="button" disabled={saving} on:click={loadBackupConfig}>Reload</Button>
        </div>
      </form>
    ...
    {:else if activeTab === 'training' && trainingForm}
      <form class="general-form" on:submit={onSubmitTraining}>
        ...
        <div class="action-row">
          ...
          <Button type="button" disabled={saving} on:click={loadTrainingConfig}>Reload</Button>
        </div>
      </form>
    {:else if activeTab === 'concepts' && conceptsForm}
