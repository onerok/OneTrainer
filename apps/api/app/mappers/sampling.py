...
from ..schemas import SamplingSettings


def load_samples(config) -> list[SampleConfig]:
...
def to_sampling_settings(config) -> SamplingSettings:
...
def apply_sampling_settings(config, settings: SamplingSettings):
