...
from ..schemas import ModelPartSettings, ModelSettings, QuantizationSettings


def to_model_settings(config) -> ModelSettings:
...
def apply_model_settings(config, settings: ModelSettings):
